...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TWELVEDATA_API_KEY": {
        ...
        "description": "API key for optional US intraday realtime quote fields such as price, percent change, and volume. Only the lightweight quote endpoint is used.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
